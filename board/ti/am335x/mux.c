...
/*2019.10.05 add by ws*/
/*
RTC_INTA  gpio0_19  I  L

P_V3_OFF  gpio1_16 O	R13	H:V3 off L:V3 on
P_V3_ON   gpio1_17 O	V14	L:V3 0ff  H:V3 on 
SPK_1	  gpio1_18 O	U14	L
SPK_2	  gpio1_19 O	T14	L
SPK_P	  gpio1_20 O	R14	L:spk off H:spk on
Relay1_O	  gpio1_21 O	V15	H: L:ON
Relay2_O	  gpio1_22 O	U15	H: L:ON
PO_CHECK gpio1_23 I	T15	L
I2C1_VP	  gpio1_30 O		L:R/W  H:protect 
LCD_IIC_CSgpio1_31 O   	H:no cs L:cs


LCD_PWR	  gpio2_1   O		H:ON    L:OFF 
WDI		  gpio2_26 O	F17	H
RS485EN	  gpio2_27 O   	L:R       H:W 

P_CHGC	  gpio3_18 O	B12	H:no chang L:chang
P_BATT	  gpio3_19 I	C13	L
P_CHG	  gpio3_20 I	D13	L
P_DC	  gpio3_21 I	A14	L
*/
static struct module_pin_mux board_pin_mux[] = {
	{OFFSET(xdma_event_intr0), (MODE(7) | SLEWCTRL | RXACTIVE )},/* gpio0[19] */\
	{OFFSET(gpmc_a0), (MODE(7) | SLEWCTRL |  PULLUP_EN | PULLUDDIS)}, /* gpio1[16] */\
	{OFFSET(gpmc_a1), (MODE(7) | SLEWCTRL |  PULLUP_EN | PULLUDDIS )}, /* gpio1[17] */\
	{OFFSET(gpmc_a2), (MODE(7) | SLEWCTRL |  PULLUP_EN | PULLUDDIS )}, /* gpio1[18] */\
	{OFFSET(gpmc_a3), (MODE(7) | SLEWCTRL |  PULLUP_EN | PULLUDDIS )},/* gpio1[19] */\
	{OFFSET(gpmc_a4), (MODE(7) | SLEWCTRL |  PULLUP_EN | PULLUDDIS )},/* gpio1[20] */\
	{OFFSET(gpmc_a5), (MODE(7) | SLEWCTRL |  PULLUP_EN | PULLUDDIS )},/* gpio1[21] */\
	{OFFSET(gpmc_a6), (MODE(7) | SLEWCTRL |  PULLUP_EN | PULLUDDIS )},/* gpio1[22] */\
	{OFFSET(gpmc_a7), (MODE(7) | SLEWCTRL |  RXACTIVE )},/* gpio1[23] */\
	{OFFSET(gpmc_a8), (MODE(7) | SLEWCTRL |  PULLUP_EN | PULLUDDIS )},/* gpio1[24] */\
	{OFFSET(gpmc_csn1),    (MODE(7) | SLEWCTRL |  PULLUP_EN | PULLUDDIS )},/* gpio1[30] */\
	{OFFSET(gpmc_csn2),    (MODE(7) | SLEWCTRL |  PULLUP_EN | PULLUDDIS )},/* gpio1[31] */\
	{OFFSET(gpmc_clk),       (MODE(7) | SLEWCTRL |  PULLUP_EN | PULLUDDIS )},/* gpio2[1] */\
	{OFFSET(mmc0_dat3),   (MODE(7) | SLEWCTRL |  PULLUP_EN | PULLUDEN )},/* gpio2[26] */\
	{OFFSET(mmc0_dat2),   (MODE(7) | SLEWCTRL |  PULLUP_EN | PULLUDDIS )},/* gpio2[27] */\
	{OFFSET(mcasp0_aclkr), (MODE(7) | SLEWCTRL |  PULLUP_EN | PULLUDDIS )},/* gpio3[18] */\
	{OFFSET(mcasp0_fsr),    (MODE(7) | SLEWCTRL | RXACTIVE )},/* gpio3[19] */\
	{OFFSET(mcasp0_axr1), (MODE(7) | SLEWCTRL | RXACTIVE )},/* gpio3[20] */\
	{OFFSET(mcasp0_ahclkx), (MODE(7) | SLEWCTRL | RXACTIVE )},/* gpio3[21] */\
	//{OFFSET(mmc0_sdwp),   (MODE(7) | SLEWCTRL |  PULLUP_EN | PULLUDEN )},/* gpio0[7] */\
	{-1},
};
static struct module_pin_mux lcd_pin_mux[] = {
	...
	{OFFSET(gpmc_clk),  (MODE(7) | SLEWCTRL | PULLUDEN |PULLUP_EN)}, // LCD_PWR_EN gpio2_1
	{OFFSET(ecap0_in_pwm0_out), (MODE(0) | PULLUDEN |PULLUP_EN)},	//*GPIO0_7  add on 2016.04.26 by threebears
	{-1},
};
...
#else
#define GPIO0_CLR		0x44E07190
#define GPIO0_SET		0x44E07194
#define GPIO1_CLR		0x4804C190
#define GPIO1_SET		0x4804C194
#define GPIO2_CLR		0x481AC190
#define GPIO2_SET		0x481AC194
#define GPIO3_CLR		0x481AE190
#define GPIO3_SET		0x481AE194

void enable_board_pin_mux(void)
{
	/* Do board-specific muxes. */
	configure_module_pin_mux(board_pin_mux);
	
	writel( (1<<17)|(1<<18)|(1<<19)|(1<<20)|(1<<30) , GPIO1_CLR);
	writel( (1<<16)|(1<<21)|(1<<22)|(1<<31) ,               GPIO1_SET);

	writel( (1<<27) ,             GPIO2_CLR);
	writel( (1<<1) |(1<<26) ,GPIO2_SET);
	
	writel( (1<<18) , GPIO3_SET);

	configure_module_pin_mux(rmii1_pin_mux);
	configure_module_pin_mux(nand_pin_mux);

	configure_module_pin_mux(lcd_pin_mux);
	writel( (1<<1) ,GPIO2_SET);//LCD_PWR	  gpio2_1   O		H:ON    L:OFF
}
#endif
